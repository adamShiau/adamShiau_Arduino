...
Uart Serial2 (&sercom0, 19, 18, SERCOM_RX_PAD_1, UART_TX_PAD_0); // rx: PA5, A4; tx: PA4, A3
...
Uart Serial3 (&sercom1, 10, 24, SERCOM_RX_PAD_3, UART_TX_PAD_2); // rx: PA19, D12; tx: PA18, D10
...
Uart Serial4 (&sercom2, 29, 28, SERCOM_RX_PAD_3, UART_TX_PAD_2);// rx: PA15, D5; tx: PA14, D4
void SERCOM24_Handler()
{
  Serial4.IrqHandler();
}
...
pinPeripheral(29, PIO_SERCOM); //sercom2.tx
pinPeripheral(28, PIO_SERCOM); //sercom2.rx

pinPeripheral(19, PIO_SERCOM_ALT); //sercom0.rx
pinPeripheral(18, PIO_SERCOM_ALT); //sercom0.tx

pinPeripheral(10, PIO_SERCOM); //sercom1.rx
pinPeripheral(24, PIO_SERCOM); //sercom1.tx
...
pinPeripheral(32, PIO_SERCOM_ALT);
