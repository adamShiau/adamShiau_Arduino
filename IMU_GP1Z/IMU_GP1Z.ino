...
unsigned int t_new, t_old=0, t_loop_start=0, t_loop_end=0, t_fn_start=0, t_fn_end=0;
...
/*** pwm ***/
  ...
  t_loop_start = micros();
  // delay(1000);
  // Serial.println("test SPFP");
  // my_f.float_val=0.15625;
  // Serial.print(my_f.bin_val[0], HEX);
  // Serial.print(", ");
  // Serial.print(my_f.bin_val[1], HEX);
  // Serial.print(", ");
  // Serial.print(my_f.bin_val[2], HEX);
  // Serial.print(", ");
  // Serial.println(my_f.bin_val[3], HEX);
