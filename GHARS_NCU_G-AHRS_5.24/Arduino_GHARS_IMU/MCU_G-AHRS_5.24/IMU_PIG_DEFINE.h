...
/*** VERSION */
#define MCU_VERSION "MCU_G-AHRS_5.24"
...
#define CMD_THRESHOLD_WX    48 //30
#define CMD_THRESHOLD_WY    49 //31
#define CMD_THRESHOLD_WZ    50 //32
...
#define MOD_FREQ_ADDR		CMD_FOG_MOD_FREQ
#define MOD_AMP_H_ADDR  	CMD_FOG_MOD_AMP_H
#define MOD_AMP_L_ADDR  	CMD_FOG_MOD_AMP_L
#define ERR_OFFSET_ADDR 	CMD_FOG_ERR_OFFSET
#define POLARITY_ADDR  		CMD_FOG_POLARITY
#define WAIT_CNT_ADDR  		CMD_FOG_WAIT_CNT
#define ERR_TH_ADDR  		CMD_FOG_ERR_TH
#define ERR_AVG_ADDR  		CMD_FOG_ERR_AVG
#define TIMER_RST_ADDR  	CMD_FOG_TIMER_RST
#define GAIN1_ADDR  		CMD_FOG_GAIN1
#define GAIN2_ADDR  		CMD_FOG_GAIN2
#define FB_ON_ADDR  		CMD_FOG_FB_ON
#define CONST_STEP_ADDR  	CMD_FOG_CONST_STEP
#define FPGA_Q_ADDR			CMD_FOG_FPGA_Q
#define FPGA_R_ADDR  		CMD_FOG_FPGA_R
/*** scale factor temperature compensation ***/
#define SF0_ADDR  		    CMD_FOG_SF0
#define SF1_ADDR  		    CMD_FOG_SF1
#define SF2_ADDR  		    CMD_FOG_SF2
#define SF3_ADDR  		    CMD_FOG_SF3
#define SF4_ADDR  		    CMD_FOG_SF4
#define SF5_ADDR  		    CMD_FOG_SF5
#define SF6_ADDR  		    CMD_FOG_SF6
#define SF7_ADDR  		    CMD_FOG_SF7
#define SF8_ADDR  		    CMD_FOG_SF8
#define SF9_ADDR  		    CMD_FOG_SF9
#define TMIN_ADDR           CMD_FOG_TMIN
#define TMAX_ADDR           CMD_FOG_TMAX
/*** end of scale factor temperature compensation ***/
#define SFB_ADDR            CMD_FOG_SFB
#define CUTOFF_ADDR         CMD_FOG_CUTOFF
/*** bias temperature compensation ***/
#define BIAS_COMP_T1_ADDR 	CMD_BIAS_COMP_T1
#define BIAS_COMP_T2_ADDR 	CMD_BIAS_COMP_T2
#define SFB_1_SLOPE_ADDR 	CMD_SFB_1_SLOPE
#define SFB_1_OFFSET_ADDR 	CMD_SFB_1_OFFSET
#define SFB_2_SLOPE_ADDR 	CMD_SFB_2_SLOPE
#define SFB_2_OFFSET_ADDR 	CMD_SFB_2_OFFSET
#define SFB_3_SLOPE_ADDR 	CMD_SFB_3_SLOPE
#define SFB_3_OFFSET_ADDR 	CMD_SFB_3_OFFSET
/*** end of bias temperature compensation ***/
#define DAC_GAIN_ADDR  		CMD_FOG_DAC_GAIN
...
#define SET_INTERNAL_CLK    INTERNAL_CLK

#define SET_EXTWDT_ENABLE  1
#define SET_EXTWDT_DISABLE 0
...
#define SYSCLOCK_INIT SET_INTERNAL_CLK
#define EXTWDT_INIT   SET_EXTWDT_ENABLE
...
/*** ATTITUDE CALI PARAMETERS*/
#define ATTI_THRESHOLD_WX_INIT 0
#define ATTI_THRESHOLD_WY_INIT 0
#define ATTI_THRESHOLD_WZ_INIT 0
