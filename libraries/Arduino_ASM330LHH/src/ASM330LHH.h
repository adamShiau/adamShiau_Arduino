...
class ASM330LHHClass {
  public:
    ASM330LHHClass(TwoWire& wire, uint8_t slaveAddress);
    ASM330LHHClass(SPIClass& spi, int csPin, int spi_clock);
    virtual ~ASM330LHHClass();
