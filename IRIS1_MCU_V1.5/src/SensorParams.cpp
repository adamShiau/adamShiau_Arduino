...
IMUParams getSensorParams(Sensor_ID id) {
    switch (id) {
        ...
        case AR_1A_EC:{
            SensorParams ASM330_GYRO(20, 0.4, 7, 300, 20, "gyro");
            SensorParams ASM330_ACCL(350, 85, 3.4, 1000, 350, "accl");
        ...
        case IRIS:{ // Using ASM330 for IRIS, 09-01-2025
            SensorParams ASM330_GYRO(20, 0.4, 7, 300, 20, "gyro");
            SensorParams ASM330_ACCL(350, 85, 3.4, 1000, 350, "accl");
            IMUParams IRIS_params(ASM330_GYRO, ASM330_ACCL);
            return IRIS_params;
        }
