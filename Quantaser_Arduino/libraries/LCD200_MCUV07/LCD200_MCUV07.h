...
#define ENC2_A 5 //rotary encoder 2A
#define ENC2_SW A0 //rotary encoeder switch for changing cursor
#define ENC2_B 2 //INT0 for rotory encoder 2B
#define PWR_OFF 3 // Vcc switch
#define LD_EN 4 // on/off the LD current
#define PZT A3 // PD5 for buzzle driver (excnage with LCDSW pin)
