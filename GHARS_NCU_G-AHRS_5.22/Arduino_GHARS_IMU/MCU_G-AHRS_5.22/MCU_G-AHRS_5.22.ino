...
const unsigned char GPS_HEADER[4] = {0xFE, 0x82, 0xFF, 0x55};  // GPS 位置封包標頭
...
void parameter_setting(byte &mux_flag, byte cmd, int value, byte fog_ch) 
{
    ...
    if(fog_ch==1){
      ...
      case CMD_DUMP_PARAMETERS: {
        ...
        // 2. 基本整數參數
        Serial1.print("\"FREQ\":");        Serial1.print(eeprom_ptr->EEPROM_Mod_freq);   Serial1.print(", ");
        Serial1.print("\"MOD_H\":");       Serial1.print(eeprom_ptr->EEPROM_Amp_H);      Serial1.print(", ");
        Serial1.print("\"MOD_L\":");       Serial1.print(eeprom_ptr->EEPROM_Amp_L);      Serial1.print(", ");
        Serial1.print("\"ERR_OFFSET\":");  Serial1.print(eeprom_ptr->EEPROM_Err_offset); Serial1.print(", ");
        Serial1.print("\"POLARITY\":");    Serial1.print(eeprom_ptr->EEPROM_Polarity);   Serial1.print(", ");
        Serial1.print("\"WAIT_CNT\":");    Serial1.print(eeprom_ptr->EEPROM_Wait_cnt);   Serial1.print(", ");
        Serial1.print("\"ERR_TH\":");      Serial1.print(eeprom_ptr->EEPROM_Err_th);     Serial1.print(", ");
        Serial1.print("\"ERR_AVG\":");     Serial1.print(eeprom_ptr->EEPROM_Err_avg);    Serial1.print(", ");
        Serial1.print("\"GAIN1\":");       Serial1.print(eeprom_ptr->EEPROM_Gain1);      Serial1.print(", ");
        Serial1.print("\"GAIN2\":");       Serial1.print(eeprom_ptr->EEPROM_Gain2);      Serial1.print(", ");
        Serial1.print("\"FB_ON\":");       Serial1.print(eeprom_ptr->EEPROM_FB_ON);      Serial1.print(", ");
        Serial1.print("\"CONST_STEP\":");  Serial1.print(eeprom_ptr->EEPROM_Const_step); Serial1.print(", ");
        Serial1.print("\"HD_Q\":");        Serial1.print(eeprom_ptr->EEPROM_Fpga_Q);     Serial1.print(", ");
        Serial1.print("\"HD_R\":");        Serial1.print(eeprom_ptr->EEPROM_Fpga_R);     Serial1.print(", ");

        // 3. 縮放係數 SF0 ~ SF9 (需呼叫 my_parameter_f 確保浮點數格式與舊版一致) [cite: 14]
        my_parameter_f_silent("SF0", IEEE_754_INT2F(eeprom_ptr->EEPROM_SF0), &my_cali_para[0]); Serial1.print(my_cali_para[0].str); Serial1.print(", ");
        my_parameter_f_silent("SF1", IEEE_754_INT2F(eeprom_ptr->EEPROM_SF1), &my_cali_para[1]); Serial1.print(my_cali_para[1].str); Serial1.print(", ");
        my_parameter_f_silent("SF2", IEEE_754_INT2F(eeprom_ptr->EEPROM_SF2), &my_cali_para[2]); Serial1.print(my_cali_para[2].str); Serial1.print(", ");
        my_parameter_f_silent("SF3", IEEE_754_INT2F(eeprom_ptr->EEPROM_SF3), &my_cali_para[3]); Serial1.print(my_cali_para[3].str); Serial1.print(", ");
        my_parameter_f_silent("SF4", IEEE_754_INT2F(eeprom_ptr->EEPROM_SF4), &my_cali_para[4]); Serial1.print(my_cali_para[4].str); Serial1.print(", ");
        my_parameter_f_silent("SF5", IEEE_754_INT2F(eeprom_ptr->EEPROM_SF5), &my_cali_para[5]); Serial1.print(my_cali_para[5].str); Serial1.print(", ");
        my_parameter_f_silent("SF6", IEEE_754_INT2F(eeprom_ptr->EEPROM_SF6), &my_cali_para[6]); Serial1.print(my_cali_para[6].str); Serial1.print(", ");
        my_parameter_f_silent("SF7", IEEE_754_INT2F(eeprom_ptr->EEPROM_SF7), &my_cali_para[7]); Serial1.print(my_cali_para[7].str); Serial1.print(", ");
        my_parameter_f_silent("SF8", IEEE_754_INT2F(eeprom_ptr->EEPROM_SF8), &my_cali_para[8]); Serial1.print(my_cali_para[8].str); Serial1.print(", ");
        my_parameter_f_silent("SF9", IEEE_754_INT2F(eeprom_ptr->EEPROM_SF9), &my_cali_para[9]); Serial1.print(my_cali_para[9].str); Serial1.print(", ");

        // 4. 溫度斷點參數
        Serial1.print("\"TMIN\":");  Serial1.print(IEEE_754_INT2F(eeprom_ptr->EEPROM_TMIN), 0); Serial1.print(", ");
        // T1~T7 通常是由 TMIN 遞增 10 度得來，若您的 eeprom_ptr 沒有儲存這些，可直接計算或印出變數 [cite: 317, 333]
        Serial1.print("\"T1\":-10, \"T2\":0, \"T3\":10, \"T4\":20, \"T5\":30, \"T6\":40, \"T7\":50, "); 
        Serial1.print("\"TMAX\":");  Serial1.print(IEEE_754_INT2F(eeprom_ptr->EEPROM_TMAX), 0); Serial1.print(", ");

        // 5. 硬體與補償參數
        Serial1.print("\"DAC_GAIN\":");  Serial1.print(eeprom_ptr->EEPROM_DAC_gain);   Serial1.print(", ");
        Serial1.print("\"DATA_RATE\":"); Serial1.print(eeprom_ptr->EEPROM_Data_delay); Serial1.print(", ");
        my_parameter_f_silent("SFB", IEEE_754_INT2F(eeprom_ptr->EEPROM_SFB), &my_cali_para[10]); Serial1.print(my_cali_para[10].str); Serial1.print(", ");
        Serial1.print("\"CUTOFF\":");    Serial1.print(eeprom_ptr->EEPROM_CUTOFF);     Serial1.print(", ");

        // 6. Bias 補償參數 (BIAS_COMP) [cite: 318, 334, 367]
        my_parameter_f_silent("BIAS_COMP_T1", IEEE_754_INT2F(eeprom_ptr->EEPROM_BIAS_COMP_T1), &my_cali_para[11]); Serial1.print(my_cali_para[11].str); Serial1.print(", ");
        my_parameter_f_silent("BIAS_COMP_T2", IEEE_754_INT2F(eeprom_ptr->EEPROM_BIAS_COMP_T2), &my_cali_para[12]); Serial1.print(my_cali_para[12].str); Serial1.print(", ");
        my_parameter_f_silent("SFB_1_SLOPE",  IEEE_754_INT2F(eeprom_ptr->EEPROM_SFB_1_SLOPE), &my_cali_para[13]); Serial1.print(my_cali_para[13].str); Serial1.print(", ");
        my_parameter_f_silent("SFB_1_OFFSET", IEEE_754_INT2F(eeprom_ptr->EEPROM_SFB_1_OFFSET), &my_cali_para[14]); Serial1.print(my_cali_para[14].str); Serial1.print(", ");
        my_parameter_f_silent("SFB_2_SLOPE",  IEEE_754_INT2F(eeprom_ptr->EEPROM_SFB_2_SLOPE), &my_cali_para[15]); Serial1.print(my_cali_para[15].str); Serial1.print(", ");
        my_parameter_f_silent("SFB_2_OFFSET", IEEE_754_INT2F(eeprom_ptr->EEPROM_SFB_2_OFFSET), &my_cali_para[16]); Serial1.print(my_cali_para[16].str); Serial1.print(", ");
        my_parameter_f_silent("SFB_3_SLOPE",  IEEE_754_INT2F(eeprom_ptr->EEPROM_SFB_3_SLOPE), &my_cali_para[17]); Serial1.print(my_cali_para[17].str); Serial1.print(", ");
        my_parameter_f_silent("SFB_3_OFFSET", IEEE_754_INT2F(eeprom_ptr->EEPROM_SFB_3_OFFSET), &my_cali_para[18]); Serial1.print(my_cali_para[18].str); Serial1.print(", ");

        // 7. 最後加入 MCU 本地的態度計算標準差參數 [cite: 134, 328]
        my_parameter_f_silent("STD_Wx", attitude_cali_coe._f.std_wx, &my_cali_para[19]); Serial1.print(my_cali_para[19].str); Serial1.print(", ");
        my_parameter_f_silent("STD_Wy", attitude_cali_coe._f.std_wy, &my_cali_para[20]); Serial1.print(my_cali_para[20].str); Serial1.print(", ");
        my_parameter_f_silent("STD_Wz", attitude_cali_coe._f.std_wz, &my_cali_para[21]); Serial1.print(my_cali_para[21].str);
...
{
  Serial.println("Enter acq_fog_parameter!");
	clear_SEL_EN(select_fn);	
}

void acq_fog(byte &select_fn, unsigned int value, byte ch)
{
	Serial.println("Enter acq_fog!");
	clear_SEL_EN(select_fn);	
}
