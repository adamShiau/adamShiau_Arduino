...
#define EEPROM_ADDR_BIAS_COMP_T1_Z    118
#define EEPROM_ADDR_BIAS_COMP_T2_Z    119
#define EEPROM_ADDR_SFB_1_SLOPE_Z     120
#define EEPROM_ADDR_SFB_1_OFFSET_Z    121
#define EEPROM_ADDR_SFB_2_SLOPE_Z     122
#define EEPROM_ADDR_SFB_2_OFFSET_Z    123
#define EEPROM_ADDR_SFB_3_SLOPE_Z     124
#define EEPROM_ADDR_SFB_3_OFFSET_Z    125
// x axis
...
#define EEPROM_ADDR_BIAS_COMP_T1_X    126
#define EEPROM_ADDR_BIAS_COMP_T2_X    127
#define EEPROM_ADDR_SFB_1_SLOPE_X     128
#define EEPROM_ADDR_SFB_1_OFFSET_X    129
#define EEPROM_ADDR_SFB_2_SLOPE_X     130
#define EEPROM_ADDR_SFB_2_OFFSET_X    131
#define EEPROM_ADDR_SFB_3_SLOPE_X     132
#define EEPROM_ADDR_SFB_3_OFFSET_X    133
// y axis
...
#define EEPROM_ADDR_BIAS_COMP_T1_Y    134
#define EEPROM_ADDR_BIAS_COMP_T2_Y    135
#define EEPROM_ADDR_SFB_1_SLOPE_Y     136
#define EEPROM_ADDR_SFB_1_OFFSET_Y    137
#define EEPROM_ADDR_SFB_2_SLOPE_Y     138
#define EEPROM_ADDR_SFB_2_OFFSET_Y    139
#define EEPROM_ADDR_SFB_3_SLOPE_Y     140
#define EEPROM_ADDR_SFB_3_OFFSET_Y    141
...
eeprom_obj eeprom_z = {
 ...
 EEPROM_ADDR_BIAS_COMP_T1_Z    ,
 EEPROM_ADDR_BIAS_COMP_T2_Z    ,
 EEPROM_ADDR_SFB_1_SLOPE_Z     ,
 EEPROM_ADDR_SFB_1_OFFSET_Z    ,
 EEPROM_ADDR_SFB_2_SLOPE_Z     ,
 EEPROM_ADDR_SFB_2_OFFSET_Z    ,
 EEPROM_ADDR_SFB_3_SLOPE_Z     ,
 EEPROM_ADDR_SFB_3_OFFSET_Z    
};
...
eeprom_obj eeprom_x = {
 ...
 EEPROM_ADDR_CUTOFF_X          ,
  //  BIAS temp. compensation
 EEPROM_ADDR_BIAS_COMP_T1_X    ,
 EEPROM_ADDR_BIAS_COMP_T2_X    ,
 EEPROM_ADDR_SFB_1_SLOPE_X     ,
 EEPROM_ADDR_SFB_1_OFFSET_X    ,
 EEPROM_ADDR_SFB_2_SLOPE_X     ,
 EEPROM_ADDR_SFB_2_OFFSET_X    ,
 EEPROM_ADDR_SFB_3_SLOPE_X     ,
 EEPROM_ADDR_SFB_3_OFFSET_X    
};
...
eeprom_obj eeprom_y = {
 ...
 EEPROM_ADDR_CUTOFF_Y          ,
  //  BIAS temp. compensation
 EEPROM_ADDR_BIAS_COMP_T1_Y    ,
 EEPROM_ADDR_BIAS_COMP_T2_Y    ,
 EEPROM_ADDR_SFB_1_SLOPE_Y     ,
 EEPROM_ADDR_SFB_1_OFFSET_Y    ,
 EEPROM_ADDR_SFB_2_SLOPE_Y     ,
 EEPROM_ADDR_SFB_2_OFFSET_Y    ,
 EEPROM_ADDR_SFB_3_SLOPE_Y     ,
 EEPROM_ADDR_SFB_3_OFFSET_Y    
};
